...
public class train_adapter extends RecyclerView.Adapter<train_adapter.myviewholder>{
    ...
    public train_adapter(ArrayList<weight_train> data, Context context) {
        this.data = data;
    ...
    @NonNull
    @Override
    public train_adapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflator = LayoutInflater.from(parent.getContext());
        View v;

        v = inflator.inflate(R.layout.homeworkout_customlayout, parent, false);
        return new train_adapter.myviewholder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull train_adapter.myviewholder holder, int position) {
